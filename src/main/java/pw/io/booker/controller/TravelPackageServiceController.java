...
public class TravelPackageServiceController {
  ...
  @GetMapping
  public List<Service> getAll(@PathVariable("travelPackageId") int travelPackageId, @RequestHeader("Authentication-token") String token) {
  ...
  @DeleteMapping
  public List<Service> deleteAll(@PathVariable("travelPackageId") int travelPackageId, @RequestHeader("Authentication-token") String token) {
  ...
  public Service updateService(@PathVariable("travelPackageId") int travelPackageId,
      @PathVariable("serviceId") int serviceId, @RequestBody Service service, @RequestHeader("Authentication-token") String token) {
